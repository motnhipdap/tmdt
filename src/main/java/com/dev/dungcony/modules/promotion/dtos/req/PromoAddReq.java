...
public record PromoAddReq(
                @NotNull(message = "Promotion type is required") PromotionType type,

                @NotBlank(message = "Promotion code is required") @Size(max = 20, message = "Code must not exceed 20 characters") String code,
